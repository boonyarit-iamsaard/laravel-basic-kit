...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/boonyarit-iamsaard/workspace/personal/laravel-basic-kit/public/storage' => 'string',
            ...
            'services.line.bot_prompt' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/boonyarit-iamsaard/workspace/personal/laravel-basic-kit/public/storage','logging.default','logging.deprecations.channel',
...
'services.google.client_id','services.google.client_secret','services.google.redirect','services.line.client_id','services.line.client_secret',
'services.line.redirect','services.line.bot_prompt','session.driver','session.lifetime','session.expire_on_close',
...
'cors.supports_credentials','view.paths','view.compiled','concurrency.default','broadcasting.default',
...
'hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','blade-heroicons.prefix','blade-heroicons.fallback',
...
'filament.assets_path','filament.cache_path','filament.livewire_loading_delay','filament.file_generation.flags','filament.system_route_prefix',
...
'livewire.navigate.progress_bar_color','livewire.inject_morph_markers','livewire.pagination_theme','blade-lucide-icons.prefix','blade-lucide-icons.fallback',
'blade-lucide-icons.class','blade-lucide-icons.attributes','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'filament.admin.resources.users.index','filament.admin.resources.users.create','filament.admin.resources.users.view','filament.admin.resources.users.edit','livewire.update','livewire.upload-file','livewire.preview-file',
'home','dashboard','profile.edit','profile.update','profile.destroy',
'register','login','password.request',
'password.email','password.reset','password.store','auth.socialite.redirect','auth.socialite.callback',
...
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','filament-actions::action-modal','filament-actions::components.group',
'filament-actions::components.modals','filament-forms::components.builder','filament-forms::components.builder.block-picker','filament-forms::components.checkbox','filament-forms::components.checkbox-list',
'filament-forms::components.code-editor','filament-forms::components.color-picker','filament-forms::components.date-time-picker','filament-forms::components.field-wrapper','filament-forms::components.file-upload',
'filament-forms::components.hidden','filament-forms::components.key-value','filament-forms::components.livewire-field','filament-forms::components.markdown-editor','filament-forms::components.modal-table-select',
'filament-forms::components.one-time-code-input','filament-forms::components.plain-field-wrapper','filament-forms::components.radio','filament-forms::components.repeater.index','filament-forms::components.repeater.simple',
'filament-forms::components.repeater.table','filament-forms::components.rich-editor','filament-forms::components.select','filament-forms::components.slider','filament-forms::components.table-select',
...
'filament-forms::components.toggle-buttons.index','filament-infolists::components.entry-wrapper','filament-notifications::database-notifications','filament-notifications::notifications','filament-panels::auth.pages.edit-profile',
'filament-panels::components.avatar.tenant','filament-panels::components.avatar.user','filament-panels::components.header.index','filament-panels::components.header.simple','filament-panels::components.layout.base',
...
'filament-panels::components.page.sub-navigation.select','filament-panels::components.page.sub-navigation.sidebar','filament-panels::components.page.sub-navigation.tabs','filament-panels::components.sidebar.group','filament-panels::components.sidebar.item',
'filament-panels::components.tenant-menu','filament-panels::components.theme-switcher.button','filament-panels::components.theme-switcher.index','filament-panels::components.topbar.database-notifications-trigger','filament-panels::components.topbar.item',
'filament-panels::components.unsaved-action-changes-alert','filament-panels::components.user-menu','filament-panels::livewire.global-search','filament-panels::livewire.sidebar','filament-panels::livewire.simple-user-menu',
'filament-panels::livewire.topbar','filament-panels::pages.page','filament-panels::pages.simple','filament-panels::resources.relation-manager','filament-panels::widgets.account-widget',
'filament-panels::widgets.filament-info-widget','filament-schemas::components.actions','filament-schemas::components.fieldset','filament-schemas::components.flex','filament-schemas::components.form',
...
'filament::components.dropdown.list.item','filament::components.fieldset','filament::components.icon','filament::components.icon-button','filament::components.input.checkbox',
'filament::components.input.index','filament::components.input.one-time-code','filament::components.input.radio','filament::components.input.select','filament::components.input.wrapper',
...
'filament::components.section.index','filament::components.tabs.index','filament::components.tabs.item','filament::components.toggle','laravel-exceptions-renderer::components.card',
...
'filament-panels::recovery-codes-modal-content.0','filament-panels::notice-of-email-change-request.0','filament-panels::error-notifications.title','filament-panels::error-notifications.body','filament-forms::components.builder.actions.clone.label',
...
'filament-forms::components.markdown_editor.tools.attach_files','filament-forms::components.markdown_editor.tools.blockquote','filament-forms::components.markdown_editor.tools.bold','filament-forms::components.markdown_editor.tools.bullet_list','filament-forms::components.markdown_editor.tools.code_block',
'filament-forms::components.markdown_editor.tools.heading','filament-forms::components.markdown_editor.tools.italic','filament-forms::components.markdown_editor.tools.link','filament-forms::components.markdown_editor.tools.ordered_list','filament-forms::components.markdown_editor.tools.redo',
'filament-forms::components.markdown_editor.tools.strike','filament-forms::components.markdown_editor.tools.table','filament-forms::components.markdown_editor.tools.undo','filament-forms::components.modal_table_select.actions.select.label','filament-forms::components.modal_table_select.actions.select.actions.select.label',
...
'filament-forms::components.repeater.actions.expand.label','filament-forms::components.repeater.actions.collapse_all.label','filament-forms::components.repeater.actions.expand_all.label','filament-forms::components.rich_editor.actions.attach_files.label','filament-forms::components.rich_editor.actions.attach_files.modal.heading',
'filament-forms::components.rich_editor.actions.attach_files.modal.form.file.label.new','filament-forms::components.rich_editor.actions.attach_files.modal.form.file.label.existing','filament-forms::components.rich_editor.actions.attach_files.modal.form.alt.label.new','filament-forms::components.rich_editor.actions.attach_files.modal.form.alt.label.existing','filament-forms::components.rich_editor.actions.custom_block.modal.actions.insert.label',
'filament-forms::components.rich_editor.actions.custom_block.modal.actions.save.label','filament-forms::components.rich_editor.actions.link.label','filament-forms::components.rich_editor.actions.link.modal.heading','filament-forms::components.rich_editor.actions.link.modal.form.url.label','filament-forms::components.rich_editor.actions.link.modal.form.should_open_in_new_tab.label',
'filament-forms::components.rich_editor.no_merge_tag_search_results_message','filament-forms::components.rich_editor.tools.align_center','filament-forms::components.rich_editor.tools.align_end','filament-forms::components.rich_editor.tools.align_justify','filament-forms::components.rich_editor.tools.align_start',
'filament-forms::components.rich_editor.tools.attach_files','filament-forms::components.rich_editor.tools.blockquote','filament-forms::components.rich_editor.tools.bold','filament-forms::components.rich_editor.tools.bullet_list','filament-forms::components.rich_editor.tools.clear_formatting',
'filament-forms::components.rich_editor.tools.code_block','filament-forms::components.rich_editor.tools.custom_blocks','filament-forms::components.rich_editor.tools.details','filament-forms::components.rich_editor.tools.h1','filament-forms::components.rich_editor.tools.h2',
'filament-forms::components.rich_editor.tools.h3','filament-forms::components.rich_editor.tools.highlight','filament-forms::components.rich_editor.tools.horizontal_rule','filament-forms::components.rich_editor.tools.italic','filament-forms::components.rich_editor.tools.lead',
'filament-forms::components.rich_editor.tools.link','filament-forms::components.rich_editor.tools.merge_tags','filament-forms::components.rich_editor.tools.ordered_list','filament-forms::components.rich_editor.tools.redo','filament-forms::components.rich_editor.tools.small',
'filament-forms::components.rich_editor.tools.strike','filament-forms::components.rich_editor.tools.subscript','filament-forms::components.rich_editor.tools.superscript','filament-forms::components.rich_editor.tools.table','filament-forms::components.rich_editor.tools.table_delete',
'filament-forms::components.rich_editor.tools.table_add_column_before','filament-forms::components.rich_editor.tools.table_add_column_after','filament-forms::components.rich_editor.tools.table_delete_column','filament-forms::components.rich_editor.tools.table_add_row_before','filament-forms::components.rich_editor.tools.table_add_row_after',
'filament-forms::components.rich_editor.tools.table_delete_row','filament-forms::components.rich_editor.tools.table_merge_cells','filament-forms::components.rich_editor.tools.table_split_cell','filament-forms::components.rich_editor.tools.table_toggle_header_row','filament-forms::components.rich_editor.tools.underline',
'filament-forms::components.rich_editor.tools.undo','filament-forms::components.select.actions.create_option.label','filament-forms::components.select.actions.create_option.modal.heading','filament-forms::components.select.actions.create_option.modal.actions.create.label','filament-forms::components.select.actions.create_option.modal.actions.create_another.label',
...
'filament-forms::components.toggle_buttons.boolean.false','filament-forms::validation.distinct.must_be_selected','filament-forms::validation.distinct.only_one_must_be_selected','filament-infolists::components.entries.text.actions.collapse_list','filament-infolists::components.entries.text.actions.expand_list',
...
'filament-notifications::database.modal.actions.clear.label','filament-notifications::database.modal.actions.mark_all_as_read.label','filament-notifications::database.modal.empty.heading','filament-notifications::database.modal.empty.description','filament-schemas::components.wizard.actions.previous_step.label',
'filament-schemas::components.wizard.actions.next_step.label','filament::button.0','filament::copyable.0','filament::modal.0','filament::pagination.0',
'filament-tables::query-builder.0','filament-tables::table.column_manager.heading','filament-tables::table.column_manager.actions.apply.label','filament-tables::table.columns.actions.label','filament-tables::table.columns.text.actions.collapse_list',
...
'filament-tables::table.default_model_label','filament-widgets::chart.actions.filter.label',);
...
'GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI','LINE_CLIENT_ID','LINE_CLIENT_SECRET',
'LINE_REDIRECT_URI','LINE_BOT_PROMPT',);
